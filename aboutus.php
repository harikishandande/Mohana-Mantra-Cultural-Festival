...
<head>
    ...
    <title>Mohana Mantra | About Us</title>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
 ...
 <div id="pricing-table" class="container">
    	<div class="bg">
	    	<div class="row">    		
	    		<h2 class="heading" style="float:left;">&nbsp;&nbsp;ABOUT <strong>US</strong></h2 >	
			</div>
			<div id="latest-event-content" class="row">
			<center>
			<img src="vid.png" />
			</center>
				<p><span style="font-family:verdana,geneva,sans-serif"><span style="line-height:1.6em">Sree Vidyanikethan Educational Institutions is proud to announce its Annual National Level Techno-Cultural Fest- Mohana Mantra 2014, which is all set to blast the castle roofs on 30</span><sup style="line-height:1.6em">th</sup><span style="line-height:1.6em">, 31</span><sup style="line-height:1.6em">st</sup><span style="line-height:1.6em"> October and 1</span><sup style="line-height:1.6em">st</sup><span style="line-height:1.6em"> November 2014.&nbsp;</span></span></p>
<center><img src="mm2k13.png" width="30%"/>
			<img src="mm2k14.png" width="30%"/></center>
<p><span style="font-family:verdana,geneva,sans-serif">Mohana Mantra 2014 is back with inspiring past and aspiring future to unleash the best talents of young calibers with an immaculate blend of nerve-racking competitions and mesmerizing events, covering wide areas ranging from music, dance, dramatics to literary, fine arts to mind boggling quizzes and games. There are several events focused on building social responsibility, soft skills and innovativeness amongst the youth. The Workshops by various groups and prodigies from all over the country is an additional charisma. Each of the three day fiestas is snowballed with an intellectual pursuit, infotainment and entertainment end to become one of the biggest fests in the country. Mohana Mantra is all about recreating and competing with the high-end competitors along with a chance to bag in cherished moments of success and ever lasting memories.</span></p>
