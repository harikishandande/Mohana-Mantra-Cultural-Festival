...
<head>
    ...
    <title>Mohana Mantra | Event Details</title>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
 ...
 <?php 
     ...
     $functions = $function->eventwithid($_GET['id']);
 ...
 ?>
  	<div id="about-us">
  		<div class="container">
  			<div class="bg">
  				<div class="about">
  					<h2 class="heading"><?php echo $function['event'];?></h2>
  					<div class="row">  		
		  				<div class="col-sm-12">
		  					...
		  					<div class="about-content">
								...
								<?php 
									 ...
									 $functions = $function2->eventthree($_GET['id']);
									 foreach ($functions as $function2)
									 {
								 ?>
			  					<p><?php echo $function2['rules'];?></p>
			  					<?php
								}
								?>
		  					</div>
							<ul class="nav nav-tabs" role="tablist" id="myTab">
								<?php 
									 ...
									 $functions = $function3->departments();
									 foreach ($functions as $function3)
									 {
								 
								 if($count ==1)
								 {?>
								 <li class="active"><a href="#<?php echo $count; ?>" role="tab" data-toggle="tab"><?php echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>" . $function3['dept_code'] . "</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"; ?></a></li>
								 <?php $count++;}
								 else{?>
							  <li class=""><a href="#<?php echo $count; ?>" role="tab" data-toggle="tab"><?php echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>" . $function3['dept_code'] . "</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"; ?></a></li>
							  <?php
							  $count++;} }
							  ?>
							</ul>
							...
							<div class="tab-content ">
								...
								$paperposter = $_GET['id'];
								 ...
								 { 
									if($count == 0)
									{	$count++;?>
										<div class="tab-pane active" id="<?php echo $count; ?>">
							...
							?>
							  ...
							  <?php  }
									 $number = 0;
									 $titlenumber = 0;
								     $function4 = new Functions;
									 $functions = $function4->departmentstitles($function3['id'],$paperposter);
							?>
							<br/>
							<?php
									 foreach ($functions as $function4)
									 {
										$number++;
									 }
							?>
							...
							<?php
									 ...
									 {  $titlenumber++;
							   ?>
							  <p><?php echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;". $titlenumber . " . " . $function4['title']; ?></p>
							  <?php
							  }
							  ?>
							  </div>
					...
					?>
						<div id="team-member">
							<h3 style="margin-left:-30px;" >Contact Co-ordinators</h3>
							<div class="row">
								<div class="row">
									<ul class="members">
										<li>
											<p><?php echo $function4['coordinator1'] ?><span><?php echo $function4['email1'] ?></span><span><?php echo $function4['phonenumber1'] ?></span></p>
										</li>
										<li>
											<p><?php echo $function4['coordinator2'] ?><span><?php echo $function4['email2'] ?></span><span><?php echo $function4['phonenumber2'] ?></span></p>
										</li>
									</ul>	
								</div>  										
							</div>
  	...
  	<div id="about-us">
  		<div class="container">
  			<div class="bg">
  				...
  				<div id="team-member">
  					<h2>Contact Co-ordinators</h2>
  					<div class="row">
  						<div class="col-sm-12">
  							<ul class="members">
  								 <?php 
									 $function3 = new Functions;
									 $functions = $function3->eventtwo($_GET['id']);
									 foreach ($functions as $function3)
									 {
								 ?>
								<li>
			  						<p><?php echo $function3['coordinator'] ?><span><?php echo $function3['email'] ?></span><span><?php echo $function3['phonenumber'] ?></span></p>
			  					</li>
								<?php
									 }
								?>
