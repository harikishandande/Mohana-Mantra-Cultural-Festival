...
<head>
    ...
    <title>Mohana Mantra | Sponsors</title>
            ...
            <div class="container">
            	<div class="row">
					...
					-->			<li><a href="first.php?group=10"><b>WORKSHOPS</b></a></li>
						...
						-->		</li>
								<li><a class="active" href="sponsors.php"><b>SPONSORS</b></a></li>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
 ...
 <div id="pricing-table" class="container">
    	<div class="bg">
	    	<div class="row">    		
	    		<h2 class="heading" style="float:left;">&nbsp;&nbsp;PLATINUM <strong>SPONSORS</strong></h2 > <a href="sponsors/Sponsorship Brochure.pdf" target="_blank" style="float:right;"> Download Sponsorship Brochure of Mohana Mantra 2014</a>	
			</div>
			<div class="row">    		
	    		<center><h3 class="heading">&nbsp;&nbsp;<span style="color:#E5E4E2;"> </span><strong>TITLE SPONSOR</strong></h3 ></center>	
			</div>
			<div id="latest-event-content" class="row">
				<center><a href="#"><img src="sponsors/andhra.jpg" width="650px"></a></center>
			</div>
			<br/>
			<div class="row">    		
	    		<center><h3 class="heading">&nbsp;&nbsp;<span style="color:#E5E4E2;"> </span><strong>ASSOCIATE SPONSOR</strong></h3 ></center>	
			</div>
			<div id="latest-event-content" class="row">
				<center><a href="https://www.facebook.com/thehangoutcafe.biz"><img src="sponsors/Hangout Logo.jpg" width="650px"></a></center>
			</div>
			<br/>
			<div class="row">    		
	<!--    		<center><h3 class="heading">&nbsp;&nbsp;<span style="color:#FFD700;">GOLD </span><strong>SPONSORS</strong></h3 ></center>	
	-->		</div>
			<div id="latest-event-content" class="row">
				
			</div>
			<div class="row">    		
	    		<h2 class="heading" style="float:left;">&nbsp;&nbsp;COURIER <strong>PARTNER</strong></h2>	
			</div>
			<div id="latest-event-content" class="row">
					<center><a href="#"><img src="sponsors/dtdc_courier-india.jpg" width="500px"></a></center>
			</div>
			<div class="row">    		
	    		<h2 class="heading" style="float:left;">&nbsp;&nbsp;MEDIA <strong>PARTNER</strong></h2>	
			</div>
			<div id="latest-event-content" class="row">
					<center><a href="#"><img src="sponsors/ebay.jpg" width="300px" ></a>
					<a href="#"><img src="sponsors/line.jpg"  width="300px" ></a></center>
			</div>
    	</div>	
    </div><!--/#contact-page-->
