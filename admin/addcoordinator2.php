...
?>
<?php 
	if(isset($_POST['paperorposter'],$_POST['dept_id'],$_POST['coordinator2'],$_POST['email2'],$_POST['phonenumber2']))
	{
	   $paperorposter= $_POST['paperorposter'];
	   $dept_id= $_POST['dept_id'];
	   $coordinator2= $_POST['coordinator2'];
	   $_SESSION['username']= $_POST['coordinator2'];
	   $email2= $_POST['email2'];
	   $phonenumber2= $_POST['phonenumber2'];
	   $sql = "UPDATE department_titles SET coordinator2 = :coordinator2, email2 = :email2, phonenumber2 = :phonenumber2 WHERE paperorposter = :paperorposter AND dept_id = :dept_id ";
	   $query = $pdo->prepare($sql);
	   $query->bindValue(":coordinator2", $coordinator2);
	   $query->bindValue(":email2", $email2);
	   $query->bindValue(":phonenumber2", $phonenumber2);
	   $query->bindValue(":paperorposter", $paperorposter);
	   $query->bindValue(":dept_id", $dept_id);
	   $query->execute();
	   $num = $query->rowCount();
	   
   	    header('Location: upload/upload2.php');
	}
	else   
	{
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row">
				   <div class="col-md-12">
					<form method="post" action="addcoordinator2.php">
						...
						Coordinator2<br>
						<input type="text" name="coordinator2" size="30" maxlength="30"  ><br><br>
						E-mail2<br>
						<input type="text" name="email2" size="30" maxlength="30"  ><br><br>
						Phone Number2<br>
						<input type="text" name="phonenumber2" size="30" maxlength="30"  ><br><br>
