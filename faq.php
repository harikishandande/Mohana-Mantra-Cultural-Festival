...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
 ...
 <div id="pricing-table" class="container">
    	<div class="bg">
	    	<div class="row">    		
	    		<h2 class="heading" style="float:left;">&nbsp;&nbsp;Frequently asked <strong>Q ???</strong></h2 >	
			</div>
			<div id="latest-event-content" class="row">
				<div class="panel-group" id="panel-329593">
				<div class="panel panel-default">
					<div class="panel-heading" style="background-color:#DC3515;">
						 <a class="panel-title collapsed" style="color:#fff;" data-toggle="collapse" data-parent="#panel-329593" href="#panel-element-1"><b>What should I bring along?</b></a>
					</div>
					<div id="panel-element-1" class="panel-collapse collapse">
						<div class="panel-body" style="color:#000;">
						<b>	*&nbsp;&nbsp;&nbsp;Copy of confirmed Registration sent through mail.<br/><br/>
							*&nbsp;&nbsp;&nbsp;It is mandatory that all participants carry their college or company IDs.<br/><br/>
							*&nbsp;&nbsp;&nbsp;Participants will have to bring along anything they require to participate in the events that are mentioned in the events tab.<br/>
						</b></div>
					</div>
				</div>
				<div class="panel panel-default">
					<div class="panel-heading" style="background-color:#DC3515;">
						 <a class="panel-title collapsed" style="color:#fff;" data-toggle="collapse" data-parent="#panel-329593" href="#panel-element-2"><b>What is this MM Id and how do I get one?</b></a>
					</div>
					<div id="panel-element-2" class="panel-collapse collapse">
						<div class="panel-body" style="color:#000;">
						<b>	*&nbsp;&nbsp;&nbsp;MM Id is an entry pass for the fest and it will help you with event registrations.<br/><br/>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;An Online payment gateway will be opened soon. You can register to all the events by paying through that.<br/>
						</b>
						</div>
					</div>
				</div>
				<div class="panel panel-default">
					<div class="panel-heading" style="background-color:#DC3515;">
						 <a class="panel-title collapsed" style="color:#fff;" data-toggle="collapse" data-parent="#panel-329593" href="#panel-element-3"><b>I have questions about my stay during the fest.</b></a>
					</div>
					<div id="panel-element-3" class="panel-collapse collapse">
						<div class="panel-body" style="color:#000;">
						<b>	*&nbsp;&nbsp;&nbsp;Our Hospitality team has your satisfaction at the top of your list.<br/><br/>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;An Online payment gateway will be opened soon. You can register to all the events by paying through that.<br/><br/>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You can also call K V Manoj (Hospitality Core Head) - +91 9676967205
						</b>
						</div>
					</div>
				</div>
				<div class="panel panel-default">
					<div class="panel-heading" style="background-color:#DC3515;">
						 <a class="panel-title collapsed" style="color:#fff;" data-toggle="collapse" data-parent="#panel-329593" href="#panel-element-4"><b>I tend to get Hungry a lot!</b></a>
					</div>
					<div id="panel-element-4" class="panel-collapse collapse">
						<div class="panel-body" style="color:#000;">
						<b>	*&nbsp;&nbsp;&nbsp;When on campus you will find a variety of food stalls selling menus to cater all your food needs.<br/>
						</b>
						</div>
					</div>
				</div>
				<div class="panel panel-default">
					<div class="panel-heading" style="background-color:#DC3515;">
						 <a class="panel-title collapsed" style="color:#fff;" data-toggle="collapse" data-parent="#panel-329593" href="#panel-element-5"><b>How medically equipped is the campus?</b></a>
					</div>
					<div id="panel-element-5" class="panel-collapse collapse">
						<div class="panel-body" style="color:#000;">
							<b>	*&nbsp;&nbsp;&nbsp;We have a team of nurses to help you if you are hurt or sick.<br/><br/>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Transport facility is right around the corner must you need further medical help.<br/>
						</b>
						</div>
					</div>
				</div>
				<div class="panel panel-default">
					<div class="panel-heading" style="background-color:#DC3515;">
						 <a class="panel-title collapsed" style="color:#fff;" data-toggle="collapse" data-parent="#panel-329593" href="#panel-element-6"><b>Tell me about the Security…</b></a>
					</div>
					<div id="panel-element-6" class="panel-collapse collapse">
						<div class="panel-body" style="color:#000;">
							<b>	*&nbsp;&nbsp;&nbsp;Sree Vidyanikethan has efficient round the clock security system with teams of trained guards.<br/><br/>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;During the fest campus security and a Disciplinary team will be present.<br/><br/>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Participants remain responsible for their things and must stay aware.<br/>
						</b></div>
					</div>
				</div>
				<div class="panel panel-default">
					<div class="panel-heading" style="background-color:#DC3515;">
						 <a class="panel-title collapsed" style="color:#fff;" data-toggle="collapse" data-parent="#panel-329593" href="#panel-element-7"><b>What about Certificates and Prizes?</b></a>
					</div>
					<div id="panel-element-7" class="panel-collapse collapse">
						<div class="panel-body" style="color:#000;">
							<b>	*&nbsp;&nbsp;&nbsp;Winners and runners up will be issued certificates and prize money.<br/><br/>
							*&nbsp;&nbsp;&nbsp;All participants in Technoholik and Kalakshetra will have appreciation and participation certificates.<br/>
						</b>
						</div>
					</div>
				</div>
				<div class="panel panel-default">
					<div class="panel-heading" style="background-color:#DC3515;">
						 <a class="panel-title collapsed" style="color:#fff;" data-toggle="collapse" data-parent="#panel-329593" href="#panel-element-8"><b>I get bored easily. How do I occupy myself when I am not participating in an Event?</b></a>
					</div>
					<div id="panel-element-8" class="panel-collapse collapse">
						<div class="panel-body" style="color:#000;">
							<b>	*&nbsp;&nbsp;&nbsp;On campus we have planned for you many games and events with spot registration that require little preparation.<br/><br/>
							&nbsp;&nbsp;&nbsp;So in your spare time you can chill in the Spot Light... Fill your tummy and in the evenings enjoy our Concerts.<br/>
						</b>
						</div>
					</div>
				</div>
				<div class="panel panel-default">
					<div class="panel-heading" style="background-color:#DC3515;">
						 <a class="panel-title collapsed" style="color:#fff;" data-toggle="collapse" data-parent="#panel-329593" href="#panel-element-9"><b>I am still wondering about many things, what should I do?</b></a>
					</div>
					<div id="panel-element-9" class="panel-collapse collapse">
						<div class="panel-body" style="color:#000;">
							<b>	*&nbsp;&nbsp;&nbsp;You can email to us Queries.MM14@gmail.com or call us at these numbers.
																Viswas Viswanath - +91 7680991992
															<br/><br/>
							&nbsp;&nbsp;&nbsp;While on campus just reach out to any of the help desks <br/>
						</b>
						</div>
					</div>
				</div>
